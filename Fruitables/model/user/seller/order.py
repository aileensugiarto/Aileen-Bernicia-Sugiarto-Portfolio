...
# ORDER
def model_order_seller(id_user):
    ...
    return render_template('user/seller/buy_products/order.html',
...
# SAVE PAYMENT INFO
def model_save_payment_info_seller():
  try:
