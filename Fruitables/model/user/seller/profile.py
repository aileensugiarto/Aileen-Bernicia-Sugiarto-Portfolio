...
def model_profile_seller():
  ...
  return render_template('user/profile/profile.html', data_profile=data)

# EDIT PROFILE
def model_edit_profile_seller(id_user):
  cur = mysql.connection.cursor()
  cur.execute("""
    SELECT u.id_user, u.name, u.username, u.telp, u.address, u.email, u.role,
  ...
  return render_template('user/profile/edit_profile.html', data_profile=data)


# PROCESS EDIT PROFILE
def model_process_edit_profile_seller():
  ...
  return redirect(url_for('profile_seller'))
