...
app.config['MYSQL_DB'] = 'mighty_fresh_ice_cream'
app.config['UPLOAD_FOLDER'] = 'static/uploads/PNG'
...
# # PESANAN
# @app.route('/pesanan/<int:id_customer>', methods=['GET', 'POST'])
# def pesanan(id_customer):
#   return model_pesanan(id_customer)
...
@app.route('/process_edit_customer', methods=['POST']) # GET: dari url, POST: langsung dari form
...
@app.route('/process_edit_category', methods=['POST']) # GET: dari url, POST: langsung dari form
...
@app.route('/process_edit_product', methods=['POST']) # GET: dari url, POST: langsung dari form
...
@app.route('/detail_transaction/<int:id>', methods=['GET'])
def detail_transaction(id):
  return model_detail_transaction(id)
